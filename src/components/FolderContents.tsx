...
export function FolderContents() {
  ...
  return (
    ...
    >
      <div className="w-full px-2 lg:px-10 xl:px-16 py-6 lg:py-16 text-foreground">
        {notification && (
        ...
        <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 lg:mb-16 px-1">
          <div className="w-full md:w-auto">
            ...
            <h1 className="text-3xl lg:text-5xl font-black text-foreground tracking-tight leading-none mb-3">
              {folder?.name}
            </h1>
                ...
                {pages.map((page) => (
                  ...
                  >
                    ...
                    <div className="flex items-start">
                      <div className="w-10 h-10 lg:w-12 lg:h-12 bg-primary/5 rounded-xl border border-primary/10 flex items-center justify-center text-primary/40 group-hover:bg-primary group-hover:text-primary-foreground transition-all duration-500">
